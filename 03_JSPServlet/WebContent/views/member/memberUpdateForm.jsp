...
#cancelBtn:hover, #updateBtn:hover, #nickCheck:hover {
	cursor: pointer;
}
		...
		<form action="<%=request.getContextPath()%>/update.me" method="post"
			...
			<table>
				<tr>
					...
					<td><input type="text" name="joinUserId"
						style="background: lightgray;" value="<%=userId%>" readonly></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" maxlength="15" name="nickName"
						value="<%=nickName%>" required></td>
					<td width="200px"><div id="nickCheck" onclick="checkNick();">중복확인</div></td>
				</tr>
				<script type="text/javascript">
				function checkNick(){
					window.open("NickNamecheckForm.jsp","NickNameCheck","width=500, height=300");
				}
				</script>
				<tr>
					<td>연락처</td>
				...
				<tr>
					...
					<td><input type="checkbox" id="sports" name="interest"
						value="운동" <%=checkedInterest[0]%>> <label for="sports">운동</label>
						<input type="checkbox" id="climbing" name="interest" value="등산"
						<%=checkedInterest[1]%>> <label for="climbing">등산</label>
						<input type="checkbox" id="fishing" name="interest" value="낚시"
						<%=checkedInterest[2]%>> <label for="fishing">낚시</label> <input
						type="checkbox" id="cooking" name="interest" value="요리"
						<%=checkedInterest[3]%>> <label for="cooking">요리</label> <input
						type="checkbox" id="game" name="interest" value="게임"
						<%=checkedInterest[4]%>> <label for="game">게임</label> <input
						type="checkbox" id="etc" name="interest" value="기타"
						<%=checkedInterest[5]%>> <label for="etc">기타</label></td>
					<td></td>
				</tr>
			</table>
